...
public class chatboat_msg extends AppCompatActivity {
    ...
    Handler hnd;
    Runnable ad;
    String url,lid,toid,cname,chatURL,url1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chatboat_msg);

        hnd=new Handler();
        listMessages= (ListView)findViewById(R.id.list_chat);
        bt1= (Button) findViewById(R.id.button_chat_send);
        adapterMessages = new MessagesAdapter(chatboat_msg.this);
...
//        toid=Chatwithstudent.councillorid[Chatwithstudent.pos];
        ...
        bt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(msggg.equalsIgnoreCase(""))
                {
                    ...
                    sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
                    sh.getString("ip","");
                    url=sh.getString("url","")+"chatbot_add_chat";
...
//                params.put("mac",maclis);
        ...
        ad=new Runnable() {
            ...
            public void run() {
                ...
                sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
                sh.getString("ip","");
                chatURL=sh.getString("url","")+"chatbot_view_chat";
                                ...
                                try {
                                    ...
                                    if (jsonObj.getString( "status" ).equalsIgnoreCase( "ok" )) {
                                        ...
                                        for (int i = 0; i < jss.length(); i++) {
                                            ...
                                            message.setMessage( js.getString( "botmsg" ) );//dbcolumnname
...
//                                                message.setUsername( Chatwithstudent.pname[Chatwithstudent.pos] );
                                                message.setUsername( "Bot" );//text
                                                message.setIncomingMessage( true );
                                            }
                                            adapterMessages.add( message );
                                            lastid = js.getString( "chatbot_chat_id" );
                                        }
...
//        startActivity( new Intent( Chat.this,Chatwithstudent.class ) );


        sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        sh.getString("ip","");
//        aid=getIntent().getStringExtra("a");
        url1=sh.getString("url","")+"chatbot_delete_chat";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            JSONObject jsonObj = new JSONObject(response);
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                Toast.makeText(chatboat_msg.this, "Thank you....", Toast.LENGTH_SHORT).show();
